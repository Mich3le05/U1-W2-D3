...
for (let i = 0; i < starWarsCharacters.length; i++) {
  switch (starWarsCharacters[i].eye_color) {
    case 'blue':
      // devo pushare questo personaggio nell'arrat blue dell'oggetto sopra (eyeColor)
      eyeColor.blue.push(starWarsCharacters[i])
      break

    case 'yellow':
      // devo pushare questo personaggio nell'arrat yellow dell'oggetto sopra (eyeColor)
      eyeColor.yellow.push(starWarsCharacters[i])
      break

    case 'brown':
      // devo pushare questo personaggio nell'arrat brown dell'oggetto sopra (eyeColor)
      eyeColor.brown.push(starWarsCharacters[i])
      break

    case 'red':
      // devo pushare questo personaggio nell'arrat red dell'oggetto sopra (eyeColor)
      eyeColor.red.push(starWarsCharacters[i])
      break

    case 'blueGrey':
      // devo pushare questo personaggio nell'arrat blueGrey dell'oggetto sopra (eyeColor)
